...
class HomeTop extends StatelessWidget {
  ...
  //construtor
   HomeTop({Key? key, required this.name}) : super(key: key);
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Container(
              ...
              width: 120, //largura crescendo
              height: 120,//altura crescendo
              //decoração
              decoration: const BoxDecoration(
              ...
              child: Container(
                width:   35, //largura crescendo
                height: 35,//altura crescendo
